      ...
      <div className="bento-card-static p-6">
        ...
        <div className="flex gap-3">
          <input
            ...
            className="flex-1 px-4 py-2.5 bg-zinc-50 dark:bg-zinc-900/50 border border-[rgba(145,70,255,0.1)] rounded-xl text-sm focus:ring-2 focus:ring-[#9146FF]/30 focus:border-[#9146FF]/30 outline-none transition-all dark:text-white"
          />
          <Button
            onPress={handleAdd}
