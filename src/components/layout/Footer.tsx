        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-5">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 max-w-sm leading-relaxed mb-6">
              The most trusted platform for Twitch growth. Real followers, viewers, and engagement to boost your streaming career.
            </p>
          ...
          <div className="md:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href="/#services" className="text-sm text-zinc-600 dark:text-zinc-400 hover:text-[#9146FF] transition-colors">
                    Services
                  </Link>
                </li>
                <li>
